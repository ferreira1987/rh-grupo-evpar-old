                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-6 form-group">
                            ...
                            <?= Html::input('text', 'requester', $model->user->full_name, ['disabled' => 'disabled', 'class' => 'form-control']) ?>
                        </div>
                        <div class="col-6 form-group">
                            <?= Html::label('Empresa'); ?>
                            <?= Html::input('text', 'requester',  $model->user->enterprise->company_name, ['disabled' => 'disabled', 'class' => 'form-control']) ?>
                        </div>
                        <div class="col-4 form-group">
                            <?= Html::label('Cargo'); ?>
                            <?= Html::input('text', 'requester',  $model->user->office, ['disabled' => 'disabled', 'class' => 'form-control']) ?>
                        </div>
                        <div class="col-4 form-group">
                            <?= Html::label('Departamento'); ?>
                            <?= Html::input('text', 'requester',  $model->user->department, ['disabled' => 'disabled', 'class' => 'form-control']) ?>
                        </div>
                        <div class="col-4 form-group">
                            <?= Html::label('Diretor/Responsável'); ?>
                            <?= Html::input('text', 'requester',  $model->user->direct_responsible, ['disabled' => 'disabled', 'class' => 'form-control']) ?>
                        </div>
                    </div>
                </div>
            </div>
