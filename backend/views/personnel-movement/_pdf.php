    ...
    <table width="100%" style="margin-top: 50px">
        ...
        <tr>
            <td colspan="1" width="50%" align="center" style="border: 0">
                ...
                <p style="font-size: 8px;">Eu como solicitante, declaro estar ciente sobre esta movimentação.</p>
            </td>
            <td colspan="1" width="50%" align="center" style="border: 0">
                <p style="font-size: 10px;">Diretor / Responsável</p><br>
                <p style="font-size: 8px;">Eu como diretor responsável, declaro estar ciente sobre esta movimentação.</p>
            </td>            
        </tr>
    </table>
</div>